...
public class EntityRelationshipTest {
    ...
    void oneToOnePersist() {
        ...
        credential.setId("alvenio");
        credential.setEmail("alveniofarhan@gmail.com");
        credential.setPassword("rahasia");
        entityManager.persist(credential);

        User user = new User();
        user.setId("alvenio");
        user.setName("Alvenio Farhan Prayogo");
    ...
    void oneToOneFind() {
        ...
        User user = entityManager.find(User.class, "alvenio");
        Assertions.assertNotNull(user.getCredential());
        Assertions.assertNotNull(user.getWallet());

        Assertions.assertEquals("alveniofarhan@gmail.com", user.getCredential().getEmail());

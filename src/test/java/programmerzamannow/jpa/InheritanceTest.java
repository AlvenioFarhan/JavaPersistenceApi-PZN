...
public class InheritanceTest {
    ...
    void singleTableInsert() {
        ...
        employee.setId("rina");
        employee.setName("Rina Putri");
        entityManager.persist(employee);

        Manager manager = new Manager();
        manager.setId("joko");
        manager.setName("Joko Priyono");
        manager.setTotalEmployee(10);
        entityManager.persist(manager);

        VicePresident vp = new VicePresident();
        vp.setId("alvenio");
        vp.setName("Alvenio Farhan");
    ...
    void singleTableFind() {
        ...
        Assertions.assertEquals("Joko Priyono", manager.getName());

        Employee employee = entityManager.find(Employee.class, "alvenio");
        VicePresident vicePresident = (VicePresident) employee;
        Assertions.assertEquals("Alvenio Farhan", vicePresident.getName());
    ...
    void joinedTableInsert() {
        ...
        creditCard.setMaskedCard("1234-1234");
